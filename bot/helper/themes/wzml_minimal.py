...
class WZMLStyle:
    ...
    ST_BN1_NAME = 'Updates 📢'
    ST_BN1_URL = 'https://t.me/wizardcloudupdates'
    ST_BN2_NAME = 'Dev 🛠️'
    ST_BN2_URL = 'https://t.me/Fury_sl'
    ST_MSG = '''<i>This bot can mirror all your links|files|torrents to Google Drive or any rclone cloud or to telegram or to ddl servers.Join Our Update Channel for more Infromations.</i>'''
    ST_BOTPM = '''<i>Now, This bot will send all your files and links here. Start Using ...</i>'''
    ST_UNAUTH = '''<i>You Are not authorized Member! </i>'''
...
<b>Validity:</b> {validity}'''
    ...
    ACTIVATED = 'Acivated Succesfully ✅'
    # ---------------------
...
┖ <b>Bot Parallel Tasks :</b> {BT}
    ...
    RESTARTING = '<i>Restarting Wizard Cl Servers Please wait...</i>'
    # ---------------------

    # async def restart_notification(): ---> __main__.py
    RESTART_SUCCESS = '''⌬ <b><i>Wizard Cloud Servers Restarted Successfully!</i></b>
┠ <b>Date:</b> {date}
┠ <b>Time:</b> {time}
┠ <b>TimeZone:</b> {timz}
┖ <b>Version:</b> {version}'''
